...
For example for version 4.2.5.1:

```
curl -L https://github.com/sol1/icingaweb2-module-netbox/archive/v4.2.5.1.tar.gz | tar xz
mv icingaweb2-module-netbox-4.2.5.1 /usr/share/icingaweb2/modules/netbox
...
There is a more detailed [baskets README](doc/baskets/README.md) in the `doc/baskets` directory.
