...
For example for version 2.10.3.1:

```
curl -L https://github.com/sol1/icingaweb2-module-netbox/archive/v2.10.3.1.tar.gz | tar xz
mv icingaweb2-module-netbox-2.10.3.1 /usr/share/icingaweb2/modules/netbox
