...
For example for version 3.1.16.1:

```
curl -L https://github.com/sol1/icingaweb2-module-netbox/archive/v3.1.16.1.tar.gz | tar xz
mv icingaweb2-module-netbox-3.1.16.1 /usr/share/icingaweb2/modules/netbox
